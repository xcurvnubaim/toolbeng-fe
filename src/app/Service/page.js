  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      ...
      <div className="text-center mt-0">
        <img src="/comSer.svg" alt="star" className="w-4/6 p-8 mx-auto" />
      </div>
      ...
      <form className="flex justify-center">
        ...
        <div className="text-center">
          <button
            type="submit"
            className={`px-4 py-2 bg-toolbeng-blue text-white rounded text-kSize hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 ${lun.className}`}
          >
            Notify Me
          </button>
        </div>
